...
<html>
<head>
<title>RECEIPES Bootstrap responsive Website Template| Home :: w3layouts</title>
	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				<div class="logo">
					<a href="home.jsp"><img src="images/foodtopia.jpg" class="img-responsive" alt="" /></a>
				</div>
				<div class="queries">
					  ...
					  <ul id="flexiselDemo3">
						<li>
							<div class="offer">
								...
								<div class="offer-text">
									<h4>Oyster Combo </h4>
									<p>Oysters are very delicious come and have a feel of what they taste like. </p>
						...
						<li>
							<div class="offer">
								...
								<div class="offer-text">
									...
									<p>Enjoy one of the best made chicken at affordable price. </p>
									<input type="button" value="Grab It">
									<span></span>
								</div>
								<div class="clearfix"></div>
						...
						<li>
							<div class="offer">
								...
								<div class="offer-text">
									<h4>Crab Combo </h4>
									<p>Come and enjoy sea food at pocket friendly price. </p>
									<input type="button" value="Grab It">
									<span></span>
								</div>
						...
						<li>
							<div class="offer">
								...
								<div class="offer-text">
									<h4>Chicken Jumbo </h4>
									<p> Come and have a taste of quality meals!. </p>
									<input type="button" value="Grab It">
									<span></span>
								</div>
				...
				<div class="col-md-8 top-cuisines">
					...
					<div class="top-cuisine-grids">
						...
						<div class="top-cuisine-grid nth-grid wow bounceIn" data-wow-delay="0.4s">
							...
							<label> Luthuli Avenue Cuisine</label>
					    </div>
						<div class="top-cuisine-grid nth-grid1 wow bounceIn" data-wow-delay="0.4s">
							...
							<label> Jerry's Cafe' Cuisine</label>
					    </div>
						<div class="top-cuisine-grid nth-grid1 wow bounceIn" data-wow-delay="0.4s">
				...
				<div class="container">
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						...
						<div class="icon-data">
							...
							<p>We honor the promises! Once you order we will be right at your place of choice. </p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						...
						<div class="icon-data">
							...
							<p> We understand the security issues in an online world that's why we have in place the international best practises in security mechanisms. </p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						...
						<div class="icon-data">
							...
							<p>For accountability purposes we help you in know the transit of the order you have placed!. </p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
