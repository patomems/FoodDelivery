				...
				<div class="col-md-6 order-form-grids">
					...
					<div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
		              ...
		              <span>Restaurant Location</span>
					   <div class="dropdown-button wow">           			
            			<select class="dropdown" tabindex="9" data-settings='{"wrapperClass":"flat"}'>
            			<option value="0">Restaurent A,Luthuli Road Nairobi</option>	
						<option value="1">Restaurent B,Thika Kenya.</option>
                                                <option value="1">Restaurent C,Thika Kenya.</option>
                                                <option value="1">Restaurent D,Thika Kenya.</option>
                                                <option value="1">Restaurent E,Thika Kenya.</option>
                                                <option value="1">Restaurent F,Nairobi Kenya.</option>
                                                <option value="1">Restaurent G,Thika Kenya.</option>
                                                <option value="1">Restaurent H,K Road Kenya.</option>
                                                <option value="1">Restaurent I,Juja Kenya.</option>
					  </select> 
					</div>
					<span>Location name</span>
			         <div class="dropdown-button">           			
            			<select class="dropdown" tabindex="9" data-settings='{"wrapperClass":"flat"}'>
            			<option value="0">Thika Town</option>	
						<option value="1">MKU campus</option>
						<option value="2">Nairobi CBD</option>
					  </select>
					</div>
					<span>cuisine-name</span>
					   <div class="dropdown-button">           			
						...
						<option value="1">cuisine-Thika</option>
						<option value="2">cuisine-Westlands</option>
					  </select> 
					</div>
					...
					<div class="col-md-2 service-section-top-row-grid4 wow swing animated" data-wow-delay= "0.4s">
						<a href="menu.jsp"><input type="submit" value="order now"></a>
					</div>
					</div>
				</div>
