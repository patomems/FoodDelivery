	...
	<div class="container">
			 ...
			 <div class="cart-header2">
				 <div class="close2"> </div>
				  <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <div class="cart-item-info">
						<h3><a href="javascript:;"> Lorem Ipsum is not simply </a><span>Pickup time:</span></h3>
						<ul class="qty">
			 ...
			 <div class="simpleCart_items"> 
					...
					<!--	<a href="order.jsp"><input type="submit" value="Order Now"></a> -->
                                              <a href="javascript:;" class="simpleCart_checkout"><input type="submit" value="Order Now"></a>
					</div>
		 </div>
		 </div>
<!-- checkout -->
