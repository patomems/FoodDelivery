...
<html>
<head>
<title>RECEIPES Bootstarp responsive Website Template| Popular-restaurant :: w3layouts</title>
		...
		<div class="Popular-Restaurants-grids">
			<div class="container">
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					...
					<div class="col-md-2 restaurent-title">
						<div class="logo-title">
							<h4><a href="javascript:;">pizza </a></h4>
						</div>
						<div class="rating">
							<span>ratings</span>
					...
					<div class="col-md-7 buy">
                                            <span>Starting only Kshs.200</span>
				...
				<div class="Popular-Restaurants-grid wow fadeInLeft" data-wow-delay="0.4s">
					...
					<div class="col-md-7 buy">
						<span>Starting only Kshs.100</span>
				...
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					...
					<div class="col-md-7 buy">
						<span>Starting only Kshs.250</span>
				...
				<div class="Popular-Restaurants-grid wow fadeInLeft" data-wow-delay="0.4s">
					...
					<div class="col-md-7 buy">
						<span>Starting only Kshs.120</span>
				...
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					...
					<div class="col-md-7 buy">
						<span>Starting only Kshs.50</span>
