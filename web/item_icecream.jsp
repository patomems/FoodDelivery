...
-->
	...
	<div class="product-sec1">
						<h3 class="heading-tittle">Ice cream</h3>
						<div class="container">
		                <div class="order-top">
							...
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<div class="info-product-price">
										<span class="item_price">ONLY  70.00</span>
										<del>80.00</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="item_name" value="Buter Scotch, 300grams" />
	...
	<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<div class="info-product-price">
										<span class="item_price">ONLY  50.00</span>
										<del>90.00</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Pineapple cream, 400grams" />
	...
	<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<div class="info-product-price">
										<span class="item_price">ONLY  60.00</span>
										<del>100.00</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Brown cream, 300grams" />
