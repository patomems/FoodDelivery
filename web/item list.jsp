			...
			<li class="item-lists">
				<div class="special-info grid_1 simpleCart_shelfItem">
					...
					<div class="pre-top">
						...
						<div class="pr-right">
							<div class="item_add"><span class="item_price"><a href="javascript:;" onclick="simpleCart.add( 'name=Exotic Combo of Cheese & Basil' , 'price=200.00' , 'quantity=1' );" >Pick</a></span></div>
						</div>
							<div class="clearfix"></div>
					</div>
					<div class="pre-top">
...
-->
	...
	<div class="product-sec1">
						<h3 class="heading-tittle">Pizza </h3>
						<div class="container">
		                <div class="order-top">
							...
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<div class="info-product-price">
										<span class="item_price">ONLY  300.00</span>
										<del>540.00</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="item_name" value="Exotic Combo of Cheese & Basil, 500grams" />
	...
	<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<div class="info-product-price">
										<span class="item_price">ONLY  340.00</span>
										<del>480.00</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Capsicum, Tomatoes, Onion, 600grams" />
	...
	<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<div class="info-product-price">
										<span class="item_price">ONLY  680.00</span>
										<del>830.00</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Chicken Tikka & Cheese, 900grams" />
				...
				<div class="contact-section-grids">
					<div class="col-md-3 contact-section-grid wow fadeInLeft" data-wow-delay="0.4s">
						...
						<ul>
							...
							<li class="data"><a href="about.jsp">About Us</a></li>
						</ul>
						<ul>
							<li><i class="point"></i></li>
