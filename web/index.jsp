...
<html>
<head>
<title> RESTAURANT RECEIPES responsive Website| login page :: w3layouts</title>
	...
	<div class="container">
		<div class="login-page">
			   ...
			   <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
				...
				<form name = "myForm" action="login_action.jsp" methode="post" onsubmit="return validate()">
				  <div>
					<span id = "numlock">Mobile no.<label>*</label></span>
					<input style="width: 320px;" type="tel" pattern="[0-9]{10}" name="mobile" title="Phone Number?!?!"/> 
				  </div>
				  <div>
					<span>Password<label>*</label></span>
					<input style="width: 520px;" type="password" placeholder="Password" name="password" required="">
